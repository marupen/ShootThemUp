...
void ASTUGameModeBase::CreateTeamsInfo()
{
    ...
    for (auto It = GetWorld()->GetControllerIterator(); It; ++It)
    {
        ...
        const auto PlayerState = (ASTUPlayerState*)(Controller->PlayerState);
...
{
    const auto KillerPlayerState = KillerController ? (ASTUPlayerState*)(KillerController->PlayerState) : nullptr;
    const auto VictimPlayerState = VictimController ? (ASTUPlayerState*)(VictimController->PlayerState) : nullptr;
